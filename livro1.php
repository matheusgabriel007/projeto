    ...
    <section class="divisoria2Cabecalho">
      ...
      <!--BOX PEDIDO 1-->
        <div class="boxPedido1">
          <img class="imgPedido" src="produtos/livro1.jpg" style="float:left;"/>
          <h1 class="tituloPedido">Livro</h1>
          <hr class="hrPedido"></hr>
          Por que Fazemos o que Fazemos? - Edição Comemorativa Com Capítulo Extra - Mario Sergio Cortella
          <hr class="hrPedido"></hr>
