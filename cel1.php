    ...
    <section class="divisoria2Cabecalho">
      ...
      <!--BOX PEDIDO 1-->
        <div class="boxPedido1">
          <img class="imgPedido" src="produtos/cel1.jpg" style="float:left;"/>
          <h1 class="tituloPedido">Iphone X</h1>
          <hr class="hrPedido"></hr>
          iPhone X Cinza Espacial 256GB Tela 5.8" IOS 11 4G Wi-Fi Câmera 12MP - Apple
          <hr class="hrPedido"></hr>
