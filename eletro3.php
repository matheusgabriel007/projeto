    ...
    <section class="divisoria2Cabecalho">
      ...
      <!--BOX PEDIDO 1-->
        <div class="boxPedido1">
          <img class="imgPedido" src="produtos/eletro3.jpg" style="float:left;"/>
          <h1 class="tituloPedido">Headset</h1>
          <hr class="hrPedido"></hr>
          Fone Headset Pro Gaming Hyperx Cloud Revolver - Hx-hscd-bk/la
          <hr class="hrPedido"></hr>
