    ...
    <section class="divisoria2Cabecalho">
      ...
      <!--BOX PEDIDO 1-->
        <div class="boxPedido1">
          <img class="imgPedido" src="produtos/cel3.jpg" style="float:left;"/>
          <h1 class="tituloPedido">Sony Xperia</h1>
          <hr class="hrPedido"></hr>
          Xperia XA1 Plus, Câmera de 23MP, Bateria de 3.430mAh, Leitor de impressão digital, Tela Full HD de 5,5", 32GB, Processador Octa-Core e 4GB RAM
          <hr class="hrPedido"></hr>
