    ...
    <section class="divisoria2Cabecalho">
      ...
      <!--BOX PEDIDO 1-->
        <div class="boxPedido1">
          <img class="imgPedido" src="imagens/produtos/camiseta1.jpg" style="float:left;"/>
          <h1 class="tituloPedido">Camiseta</h1>
          <hr class="hrPedido"></hr>
          Características:Composição: 100% algodão. - Modelagem: regular unissex, tamanho tradicional - Estampa frontal em Film de Recorte Importado. Trata-se de PERSONALIZAÇÃO própria da empresa. - Modelagem que Veste Bem! - Acabamentos Reforçados. - Estampa não sai e não racha. - Trabalhamos apenas com os melhores tecidos do mercado. - Estamos a disposição para quaisquer duvidas.
          <hr class="hrPedido"></hr>
