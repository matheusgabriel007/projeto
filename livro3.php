    ...
    <section class="divisoria2Cabecalho">
      ...
      <!--BOX PEDIDO 1-->
        <div class="boxPedido1">
          <img class="imgPedido" src="produtos/livro3.jpg" style="float:left;"/>
          <h1 class="tituloPedido">Livro</h1>
          <hr class="hrPedido"></hr>
          Qual é a Tua Obra ? Inquietações Propositivas Sobre Ética , Liderança e Gestão - Mario Sergio Cortella
          <hr class="hrPedido"></hr>
